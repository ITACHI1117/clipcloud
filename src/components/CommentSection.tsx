          ...
          <div className="flex items-end space-x-3">
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full px-4 py-3 bg-background text-foreground text-[16px] rounded-2xl border-2 resize-none text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-background transition-all"
                rows="1"
