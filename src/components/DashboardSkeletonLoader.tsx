...
const DashboardSkeletonLoader = () => {
  return (
    <div className="min-h-screen bg-background-50">
      {/* Header Skeleton */}
      {/* <header className="border-b border-background-200 bg-white/50 backdrop-blur-xl sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 py-4">
          <div className="flex items-center space-x-2">
            <div className="flex items-center space-x-1">
              <div className="p-2 bg-background-200 rounded-full animate-pulse">
                <ArrowLeft className="w-5 h-5 text-background-400" />
              </div>
              <div className="hidden md:flex w-10 h-10 bg-background-200 rounded-xl animate-pulse"></div>
              <div>
                <div className="h-4 bg-background-200 rounded animate-pulse w-24 mb-1"></div>
                <div className="hidden md:block h-3 bg-background-200 rounded animate-pulse w-32"></div>
              </div>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="bg-background-200 px-4 py-2 rounded-full animate-pulse w-12 h-10"></div>
            <div className="bg-background-200 px-4 py-2 rounded-full animate-pulse w-20 h-10"></div>
          </div>
        </div>
      </header> */}
